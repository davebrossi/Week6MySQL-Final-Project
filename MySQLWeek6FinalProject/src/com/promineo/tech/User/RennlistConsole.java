...
import com.promineo.tech.controllers.RennlistController;

public class RennlistConsole {
	private static RennlistViewModel viewModel;
	...
	public static void main(String[] args) {
		...
		try {
			...
			do {
				viewModel = new RennlistViewModel();
				DisplayMainMenu();
				DisplayCrudMenu();
				DisplayDetailsScreen();

				if (viewModel.MainMenuChoice != MainMenuChoice.EXIT) {
					RennlistController rennlistController = new RennlistController(viewModel);
					rennlistController.StartRennlistService();
				}
